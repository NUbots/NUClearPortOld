...
Vagrant.configure("2") do |config|
  ...
  if ['nubots-b767f2s', 'Ne', 'Jake', 'brain', 'reasearchlaptop'].include?(Socket.gethostname)
  ...
  config.vm.define "nuclearportvm", primary: true do |nuclearport|
    ...
    if ['Ne', 'jordan-XPS13', 'taylor-ubuntu', 'bidski-laptop'].include?(Socket.gethostname) # NUbugger Port
